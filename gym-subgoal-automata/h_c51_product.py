# docs and experiment results can be found at https://docs.cleanrl.dev/rl-algorithms/h_c51_product_multi/#c51py
import random
import time
...
if __name__ == "__main__":
    ...
    if args.track:
        ...
        wandb.tensorboard.patch(root_logdir=f"h_c51_product/runs/{run_name}/train")
        wandb.init(
            ...
            monitor_gym=True,
            save_code=True,
            group=f"OfficeWorld-h_c51_product_{args.exploration_fraction}_{args.run_code}",
        )
    writer = SummaryWriter(f"h_c51_product/runs/{run_name}/train")
    writer.add_text(
        "hyperparameters",
        "|param|value|\n|-|-|\n%s"
