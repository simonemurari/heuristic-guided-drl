...
if __name__ == "__main__":
    ...
    parser.add_argument("--wandb_group", type=str, default="DSAC-v2_SparseReacherHeuristic-v2", help="Wandb group name")
    ...
    parser.add_argument(
        ...
        type=str,
        default="TanhGaussHEURISTICDistribution",
    ...
    parser.add_argument("--value_learning_rate", type=float, default=0.00025)
    parser.add_argument("--policy_learning_rate", type=float, default=0.00025)
    ...
    parser.add_argument("--end_e", type=float, default=0.2)
    ...
    parser.add_argument("--buffer_warm_size", type=int, default=50000)
    ...
    parser.add_argument("--noise_params", type=dict, default={"mean": 0, "std": 0.1}, help="Parameters for noise")
    ...
    parser.add_argument("--save_folder", type=str, default=f'./results/DSACV2/{wandb_group}_seed={seed}_{datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S")}')
