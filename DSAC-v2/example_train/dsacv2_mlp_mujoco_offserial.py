...
if __name__ == "__main__":
    ...
    parser.add_argument("--replay_batch_size", type=int, default=2000)
    # Period of sampling
    ...
    parser.add_argument("--save_folder", type=str, default=f'./results/DSACV2/reacher_{datetime.datetime.now().strftime("%Y%m%d_%H%M%S")}')
